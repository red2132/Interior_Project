...
<!-- banner part start-->
                                ...
                                <div class="col-lg-5 col-md-8">
                                    <div class="banner_text">
                                        <div class="banner_text_iner">
                                            <h1>이벤트 공지 배너 슬라이드 - 일단 2개 빼고 주석처리해놓음
                                                </h1>
                                            <p>내용!!!!ㅁㅇㄹㅁㄴ
                                            ㅁㅇㄹㅁㄴㅇㄹㅁㄴㅇㄹㅁㄴㅇㄹㅁㄴ
                                            ㅁㅇㄹㅁㄴㅇㄹㅁㄴㅇㄹㅁㅇㄴ</p>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="section_tittle text-center">
                        <h2>새상품(인기상품) 카테고리 (카테고리마다 사진 하나씩 구해서 해당 카테고리로 바로 목록출력)
                        </h2>
                    </div>
                </div>
            </div>
    ...
    <section class="product_list section_padding">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-12">
                    <div class="section_tittle text-center">
                        <h2>새상품(2줄 슬라이드 -> 추천??) <span>shop</span></h2>
                    </div>
                </div>
            </div>
            <div class="row">
	...
	<div class="row justify-content-center">
	<div class="col-lg-7">
	<h1>관련 뉴스 실시간 데이터 수집 및 출력(vue) 넣기 </h1>
	</div>
	</div>
	</div>
	</section>
            ...
            <div class="row align-items-center">
                <div class="col-lg-12">
                    ...
                    <div class="single_client_logo">
                        <a href="https://www.iloom.com/"><img src="../template/img/client_logo/1.png" alt=""></a>
                    </div>
                    <div class="single_client_logo">
                        <a href="https://www.hanssem.com/"><img src="../template/img/client_logo/2.png" alt=""></a>
                    </div>
                    <div class="single_client_logo">

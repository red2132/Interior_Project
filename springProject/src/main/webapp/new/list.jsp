                            ...
                            <div class="widgets_inner">
                                <ul class="list">
                                    <c:forEach var="c1" items="${cateList }">
                                    	...
                                    	<li><a href="../new/list.do?cate1=${c1 }"><span ${style }>${c1 }</span></a></li>
                                    </c:forEach>
                                </ul>
                            </div>
                        </aside>
                            ...
                            <div class="widgets_inner">
                                <ul class="list">
                                    <c:forEach var="c2" items="${cate2List }">
                                    	...
                                    	<li><a href="../new/list.do?cate1=${cate1 }&cate2=${c2 }"><span ${style }>${c2 }</span></a></li>
                                    </c:forEach>
                                </ul>
                            </div>
                        </aside>
                            ...
                            <div class="pageination">
                                <nav aria-label="Page navigation example">
                                    <ul class="pagination justify-content-center">
                                        ...
                                        <li class="page-item">
                                            <a class="page-link" href="../new/list.do?cate1=${cate1 }&cate2=${cate2 }&page=${startPage-1 }" aria-label="Previous">
                                        ...
                                        <c:forEach var="i" begin="${startPage }" end="${endPage }">
	                                        ...
	                                        <li ${style }><a class="page-link" href="../new/list.do?cate1=${cate1 }&cate2=${cate2 }&page=${i }">${i }</a></li>
                                        </c:forEach>
                                        <c:if test="${endPage<totalpage }">
                                        <li class="page-item">
                                            <a class="page-link" href="../new/list.do?cate1=${cate1 }&cate2=${cate2 }&page=${endPage+1 }" aria-label="Next">
